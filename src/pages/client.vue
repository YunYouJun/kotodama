...
<template>
  <div class="shadow max-w-1000px rounded" bg="white" dark="bg-black" m="auto" p="x-2 y-4">
    <a class="inline-flex flex-col rounded shadow-md transition" hover="shadow-xl" m="auto t-1s b-3" p="2" :href="url + pageUrl"
          target="_blank">
      <h2 m="1">{{ title }}</h2>
